...
const discountedPrice = computed(() => {
  ...
  return new Intl.NumberFormat('en-US', {
    style: 'currency',
    currency: 'USD',
  }).format(props.product.price - discountAmount);
});
...
1. ✓ Pure function of props (no side effects)
2. ✓ All state is derived from props via computed
3. ✓ Emits events for parent coordination
4. ✓ Zero API calls or store access
5. ✓ Fully typed TypeScript (strict mode)
6. ✓ Accessibility: ARIA labels, keyboard navigation
7. ✓ Tailwind CSS utilities (no scoped styles)
8. ✓ Reusable across different contexts
9. ✓ Easy to test (predictable inputs/outputs)
10. ✓ Clear structure: setup → computed → handlers → template
-->
